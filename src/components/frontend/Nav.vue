    ...
    <header class="fixed w-full bg-white shadow-md" x-data="{menuOpen: false}">
        ...
        <nav class="container flex flex-wrap items-center px-4 mx-auto">
            ...
            <div class="hidden w-full ml-auto lg:block lg:w-auto">
                ...
                <router-link to="/contact" class="block text-xl px-4 py-2 font-medium hover:text-indigo-900 lg:inline-block">ติดต่อเรา</router-link>
                <router-link to="/register" class="block text-xl px-4 py-2 font-medium hover:text-indigo-900 lg:inline-block">สมัครสมาชิก</router-link>
                <div class="inline-block px-4 py-2">
                    <router-link to="/login" class="inline-block px-6 py-2 text-xl text-white bg-indigo-600 border-2 border-indigo-600 rounded-md hover:text-indigo-600 hover:bg-indigo-100">เข้าสู่ระบบ</router-link>
                </div>
            </div>
        </nav>
